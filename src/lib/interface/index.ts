...
export type { KeyedAccessorPropertyDescriptor } from './keyed-accessor-property-descriptor.interface';
export type { PropertyDescriptors } from './property-descriptors.interface';
export type { PropertyDescriptorChain } from './property-descriptor-chain.interface';
